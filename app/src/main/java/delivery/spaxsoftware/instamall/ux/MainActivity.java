 ...
 *******************************************************************************/
package delivery.spaxsoftware.instamall.ux;
...
import delivery.spaxsoftware.instamall.BuildConfig;
...
import delivery.spaxsoftware.instamall.entities.Banner;
import delivery.spaxsoftware.instamall.entities.User;
import delivery.spaxsoftware.instamall.entities.cart.CartInfo;
...
import delivery.spaxsoftware.instamall.interfaces.LoginDialogInterface;
import delivery.spaxsoftware.instamall.utils.Analytics;
import delivery.spaxsoftware.instamall.utils.JsonUtils;
import delivery.spaxsoftware.instamall.utils.MsgUtils;
import delivery.spaxsoftware.instamall.utils.MyRegistrationIntentService;
import delivery.spaxsoftware.instamall.utils.Utils;
import delivery.spaxsoftware.instamall.ux.dialogs.LoginDialogFragment;
import delivery.spaxsoftware.instamall.ux.fragments.AccountEditFragment;
import delivery.spaxsoftware.instamall.ux.fragments.AccountFragment;
import delivery.spaxsoftware.instamall.ux.fragments.BannersFragment;
import delivery.spaxsoftware.instamall.ux.fragments.CartFragment;
import delivery.spaxsoftware.instamall.ux.fragments.CategoryFragment;
import delivery.spaxsoftware.instamall.ux.fragments.DrawerFragment;
import delivery.spaxsoftware.instamall.ux.fragments.OrderCreateFragment;
import delivery.spaxsoftware.instamall.ux.fragments.OrderFragment;
import delivery.spaxsoftware.instamall.ux.fragments.OrdersHistoryFragment;
import delivery.spaxsoftware.instamall.ux.fragments.PageFragment;
import delivery.spaxsoftware.instamall.ux.fragments.ProductFragment;
import delivery.spaxsoftware.instamall.ux.fragments.SettingsFragment;
import delivery.spaxsoftware.instamall.ux.fragments.WishlistFragment;
    ...
    private void getCartCount(boolean initialize) {
        ...
        if (cartCountView != null) {
            ...
            if (user == null) {
                ...
                if (initialize) {
                    String url = String.format(EndPoints.CART, SettingsMy.getActualNonNullShop(this).getId()) + "&id=" + user.getId();
                    ...
                    String url = String.format(EndPoints.CART_INFO, SettingsMy.getActualNonNullShop(this).getId()) + "&id=" + user.getId();
