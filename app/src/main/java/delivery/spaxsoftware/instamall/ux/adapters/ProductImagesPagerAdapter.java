...
import delivery.spaxsoftware.instamall.views.TouchImageView;

/**
 * Simple images pager adapter. Uses {@link delivery.spaxsoftware.instamall.views.TouchImageView} for zooming single images.
 */
