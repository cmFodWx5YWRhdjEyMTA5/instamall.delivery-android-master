...
import delivery.spaxsoftware.instamall.entities.cart.Cart;
import delivery.spaxsoftware.instamall.entities.cart.CartProductItem;
import delivery.spaxsoftware.instamall.entities.delivery.Delivery;
import delivery.spaxsoftware.instamall.entities.delivery.DeliveryRequest;
import delivery.spaxsoftware.instamall.entities.delivery.Payment;
import delivery.spaxsoftware.instamall.entities.delivery.Shipping;
import delivery.spaxsoftware.instamall.entities.order.Order;
import delivery.spaxsoftware.instamall.interfaces.PaymentDialogInterface;
import delivery.spaxsoftware.instamall.interfaces.ShippingDialogInterface;
...
import delivery.spaxsoftware.instamall.ux.dialogs.OrderCreateSuccessDialogFragment;
import delivery.spaxsoftware.instamall.ux.dialogs.PaymentDialogFragment;
import delivery.spaxsoftware.instamall.ux.dialogs.ShippingDialogFragment;
