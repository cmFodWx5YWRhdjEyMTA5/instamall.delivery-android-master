 ...
 *******************************************************************************/
package delivery.spaxsoftware.spaxshop.ux;
...
import delivery.spaxsoftware.spaxshop.BuildConfig;
import delivery.spaxsoftware.spaxshop.CONST;
import delivery.spaxsoftware.spaxshop.MyApplication;
import delivery.spaxsoftware.spaxshop.R;
import delivery.spaxsoftware.spaxshop.SettingsMy;
import delivery.spaxsoftware.spaxshop.api.EndPoints;
import delivery.spaxsoftware.spaxshop.api.GsonRequest;
import delivery.spaxsoftware.spaxshop.api.JsonRequest;
import delivery.spaxsoftware.spaxshop.entities.Banner;
import delivery.spaxsoftware.spaxshop.entities.User;
import delivery.spaxsoftware.spaxshop.entities.cart.CartInfo;
...
import delivery.spaxsoftware.spaxshop.interfaces.LoginDialogInterface;
import delivery.spaxsoftware.spaxshop.utils.Analytics;
import delivery.spaxsoftware.spaxshop.utils.JsonUtils;
import delivery.spaxsoftware.spaxshop.utils.MsgUtils;
import delivery.spaxsoftware.spaxshop.utils.MyRegistrationIntentService;
import delivery.spaxsoftware.spaxshop.utils.Utils;
import delivery.spaxsoftware.spaxshop.ux.dialogs.LoginDialogFragment;
import delivery.spaxsoftware.spaxshop.ux.fragments.AccountEditFragment;
import delivery.spaxsoftware.spaxshop.ux.fragments.AccountFragment;
import delivery.spaxsoftware.spaxshop.ux.fragments.BannersFragment;
import delivery.spaxsoftware.spaxshop.ux.fragments.CartFragment;
import delivery.spaxsoftware.spaxshop.ux.fragments.CategoryFragment;
import delivery.spaxsoftware.spaxshop.ux.fragments.DrawerFragment;
import delivery.spaxsoftware.spaxshop.ux.fragments.OrderCreateFragment;
import delivery.spaxsoftware.spaxshop.ux.fragments.OrderFragment;
import delivery.spaxsoftware.spaxshop.ux.fragments.OrdersHistoryFragment;
import delivery.spaxsoftware.spaxshop.ux.fragments.PageFragment;
import delivery.spaxsoftware.spaxshop.ux.fragments.ProductFragment;
import delivery.spaxsoftware.spaxshop.ux.fragments.SettingsFragment;
import delivery.spaxsoftware.spaxshop.ux.fragments.WishlistFragment;
