...
import delivery.spaxsoftware.spaxshop.entities.Shop;
import delivery.spaxsoftware.spaxshop.entities.ShopResponse;
import delivery.spaxsoftware.spaxshop.testing.EspressoIdlingResource;
...
import delivery.spaxsoftware.spaxshop.ux.adapters.ShopSpinnerAdapter;
import delivery.spaxsoftware.spaxshop.ux.dialogs.LoginDialogFragment;
import timber.log.Timber;

import static delivery.spaxsoftware.spaxshop.SettingsMy.PREF_ACTUAL_SHOP;
import static delivery.spaxsoftware.spaxshop.SettingsMy.getSettings;
...
public class SplashActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        ed.putString(PREF_ACTUAL_SHOP,"{\"id\":21,\"name\":\"English\",\"description\":\"\",\"url\":\"\",\"logo\":\"\",\"google_ua\":\"UA-73690730-4\",\"language\":\"en\",\"currency\":\"USD\",\"flag_icon\":\"http:\\/\\/77.93.198.186\\/images\\/flags\\/48\\/us.png\"}");
        ed.apply();
        //My Code
