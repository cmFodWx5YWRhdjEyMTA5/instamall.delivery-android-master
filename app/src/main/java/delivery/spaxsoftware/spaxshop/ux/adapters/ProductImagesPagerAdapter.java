...
import delivery.spaxsoftware.spaxshop.views.TouchImageView;

/**
 * Simple images pager adapter. Uses {@link delivery.spaxsoftware.spaxshop.views.TouchImageView} for zooming single images.
 */
