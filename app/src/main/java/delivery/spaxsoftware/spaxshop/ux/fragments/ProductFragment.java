package delivery.spaxsoftware.spaxshop.ux.fragments;
...
import delivery.spaxsoftware.spaxshop.entities.product.ProductColor;
import delivery.spaxsoftware.spaxshop.entities.product.ProductSize;
import delivery.spaxsoftware.spaxshop.entities.product.ProductVariant;
import delivery.spaxsoftware.spaxshop.interfaces.LoginDialogInterface;
import delivery.spaxsoftware.spaxshop.interfaces.ProductImagesRecyclerInterface;
import delivery.spaxsoftware.spaxshop.interfaces.RelatedProductsRecyclerInterface;
import delivery.spaxsoftware.spaxshop.interfaces.RequestListener;
...
import delivery.spaxsoftware.spaxshop.utils.RecyclerMarginDecorator;
import delivery.spaxsoftware.spaxshop.utils.Utils;
import delivery.spaxsoftware.spaxshop.ux.MainActivity;
import delivery.spaxsoftware.spaxshop.ux.adapters.ColorSpinnerAdapter;
import delivery.spaxsoftware.spaxshop.ux.adapters.ProductImagesRecyclerAdapter;
import delivery.spaxsoftware.spaxshop.ux.adapters.RelatedProductsRecyclerAdapter;
import delivery.spaxsoftware.spaxshop.ux.adapters.SizeVariantSpinnerAdapter;
import delivery.spaxsoftware.spaxshop.ux.dialogs.LoginDialogFragment;
import delivery.spaxsoftware.spaxshop.ux.dialogs.LoginExpiredDialogFragment;
import delivery.spaxsoftware.spaxshop.ux.dialogs.ProductImagesDialogFragment;
